...
public final class QueryUtils {
    ...
    //private static final String SAMPLE_JSON_RESPONSE = /** Sample JSON response for a USGS query */
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0;i< jsonArray.length() ;i++){
                ...
                String eventPage = properties.getString("url");
                Date date = new Date(time);



                earthquakes.add(new Earthquake(magnitude,place,time,eventPage));
